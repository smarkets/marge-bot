...
To insert the key into env variable statically, for example env file used by docker-compose:
```bash
ruby -e 'print "MARGE_SSH_KEY="; p ARGF.read' marge-bot-ssh-key >> .env
```
